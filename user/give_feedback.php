...
<form method="post">
  ...
  <table class="table table-bordered" style="margin-top:50px">
    <tr>
      ...
      <select name="faculty" class="form-control">
        <option values="Dr. Mukesh Kumar">Dr. Mukesh Kumar</option>
        <option values="Bilal Ahmed">Bilal Ahmed</option>
        <option values="Kumar Vishal">Kumar Vishal</option>
      </select>
      </td>
    </tr>
  </table>
  ...
  <table  class="table table-bordered" >
    <td>
      <b>4:</b> Teacher is punctual,arrives on time and leaves on time:
    </td>
    <td> 
  ...
  <table  class="table table-bordered" >
    <tr>
      <td>
        <b>11:</b>Teacher was always fair and impartial:
      </td>
      <td>
